 ...
 *  properites:
 *
 *    kind: used to set storage and db path ie. `cms/${kind}/${type}`
 *
...
class SpritefulCmsImageEditor extends SpritefulElement {
  static get is() { return 'cms-image-editor'; }
  ...
  __publishChangesBtnDisabledChanged(disabled) {
    this.fire('cms-image-editor-changes-ready', {ready: !disabled});
  }
